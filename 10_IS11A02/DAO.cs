...
namespace BTN_10_SO_26
{
    class DAO
    {
        ...
        public static string ConnecttionString = "Data Source=DESKTOP-UGGQ7TP\\SQLEXPRESS;Initial " +
            "Catalog=QLCuaHangNoiThat;Integrated Security=True";

        public static void OpenConnection()
        {
            conn = new SqlConnection();
            conn.ConnectionString = ConnecttionString;
            try
            {
                conn.Open();
...
(Convert.ToInt32(parts[1]) >= 1) && (Convert.ToInt32(parts[1]) <= 12) && (Convert.ToInt32(parts[2]) >= 1900))
        ...
        public static string GetFieldValues(string sql)//Lấy DL từ 1 câu lệnh SQL
        {
            DAO.OpenConnection();
            string ma = "";
